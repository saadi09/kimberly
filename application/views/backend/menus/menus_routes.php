				...
				<div class="row">
					<div class="col-12">
						<div class="card animated fadeIn">
							<div class="card-header">
								<h3 class="card-title">Manage Menus Routes</h3>
								<div class="float-right">
									<div class="actions" style="">
										<a href="<?= base_url('menus/add_menu_route')?>" class="btn bg-gradient-primary btn-sm"><span class="fa fa-plus-circle"></span> &nbsp;Add</a>
									</div>
								</div>
							</div>
							<!-- /.card-header -->
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<?php for($i=0; $i<count($routes); $i++): ?>
										<tr>
											...
											<td align="center">
												<a href="<?= base_url('Menus/edit_menu_route/'.$routes[$i]['route_id'])?>" class="btn bg-gradient-primary btn-sm"><span class="fa fa-edit"></span></a>
												<button type="button" onclick="validate(this)" value="" class="btn bg-gradient-danger btn-sm"><span class="fa fa-trash"></span></button>
											</td>
										</tr>
									<?php endfor; ?>
									</tbody>
